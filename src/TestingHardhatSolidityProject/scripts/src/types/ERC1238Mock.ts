...
export interface ERC1238MockInterface extends utils.Interface {
  functions: {
    ...
    "mintBatchToEOA(address,uint256[],uint256[],uint8,bytes32,bytes32,bytes)": FunctionFragment;
    "mintToContract(address,uint256,uint256,bytes)": FunctionFragment;
    "mintToEOA(address,uint256,uint256,uint8,bytes32,bytes32,bytes)": FunctionFragment;
